...
module.exports = async (pluginConfig, context) => {
  ...
  const {
    data: {upload_url: uploadUrl, html_url, id: releaseId},
  ...
  try {
    ...
    logger.error('Failed to set release to draft=false. It is probably already published.');
  }

  logger.log('Published GitHub release: %s', url);
  return {url: html_url, name: RELEASE_NAME, id: releaseId};
};
